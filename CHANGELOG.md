...
* drop support for v18 & fastify@v4 ([#7](https://github.com/piscinajs/fastify-locks/issues/7))

### Features

* drop support for v18 & fastify@v4 ([#7](https://github.com/piscinajs/fastify-locks/issues/7)) ([f6485cf](https://github.com/piscinajs/fastify-locks/commit/f6485cffedeeecaa56d106b3b7eb6e50cbdf32fb))
