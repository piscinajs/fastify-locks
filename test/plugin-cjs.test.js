...
const fastifyLocksPlugin = require('../plugin');

test('It should correctly add fastify decorators - CommonJS', async (t) => {
  t.plan(3);
...
test('It should be able to use piscina-locks request - CommonJS', async (t) => {
  t.plan(2);
